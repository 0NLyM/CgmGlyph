...
/**
 * CGM trend direction. Lives here rather than alongside the reading models because
 * [PixelFont.arrowSets] is keyed by it -- the arrow glyphs and the enum that indexes them have to
 * travel together for this module to stand on its own.
 */
enum class Trend {
